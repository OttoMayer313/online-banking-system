...
Copy the folder [net-banking](https://github.com/OttoMayer313/online-banking-system/tree/master/net-banking) or the files in it to the location of the localhost. For example "/var/www/html", the loaction of localhost in Ubuntu.

Import the [net_banking.sql](https://github.com/OttoMayer313/online-banking-system/blob/master/net_banking.sql) database into your MySQL setup.

Edit the file [connect.php](https://github.com/OttoMayer313/online-banking-system/blob/master/net-banking/connect.php) and give proper username and password of your MySQL setup.
...
All the passwords and the usernames of both the admin and the customer can be found in the database i.e. in the file [net_banking.sql](https://github.com/OttoMayer313/online-banking-system/blob/master/net_banking.sql).
...
## Authors
* [OttoMayer313](https://github.com/OttoMayer313/)
